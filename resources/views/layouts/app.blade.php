        ...
        <div class="container-xl">
          ...
          <img src="{{ asset('images/Logo-Brand-2.png') }}" alt="Logo Brand 2" class="navbar-brand-image">
                    ...
                    <div class="collapse navbar-collapse" id="navbar-menu">
                        <div>
                            <div
                                class="container-xl d-flex justify-content-between"
                            >
                                <ul class="navbar-nav">
                                    <li class="nav-item">
                                        <a
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    />
                                                    <path
                                                        d="M3 21v-13a2 2 0 0 1 2 -2h6l3 3h6a2 2 0 0 1 2 2v10a2 2 0 0 1 -2 2h-16a2 2 0 0 1 -2 -2z"
                                                    />
                                                    <path
                    ...
                    <div class="navbar-nav flex-row order-md-last">
                        ...
                        <div class="nav-item dropdown">
                            <a
                                href="{{ route('loginJobSeeker') }}"
                                class="nav-link d-flex lh-1 text-reset p-0"
                                data-bs-toggle="dropdown"
                                aria-label="Open user menu"
                            >
                                <span class="avatar avatar-sm mt-2">
                                    @if (Auth::check() && $jobSeeker &&
                                    $jobSeeker->profile_picture)
                                    <img
                                        class="avatar avatar-sm"
                                        src="{{ $jobSeeker->profile_picture ? asset('storage/profile_pictures/'.$jobSeeker->profile_picture) : '' }}"
                                    />
                                    @else
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                ...
                                <div class="d-none d-xl-block ps-2 mt-2">
                                    <div>
                                        {{ $jobSeeker->job_seeker_name ?? 'Masuk' }}
                                    </div>
                            ...
                            >
                                ...
                                >
                                <a
                                    href="{{ route('savedJobs') }}"
                                    class="dropdown-item"
                                    >Pekerjaan Tersimpan</a
                                >
                                <a
                                    href="{{ route('jobseeker.history') }}"
                                    class="dropdown-item"
                                    >Riwayat Lamaran</a
                                >
                                <a
            ...
            <footer class="pt-5 pb-5">
                <div class="container">
                    <div class="row">
                        <div
                            class="col-md-3 animate__animated animate__fadeInLeft"
                        >
                            <h5>Kontak Kami</h5>
                        ...
                        >
                            <h5>Tentang Kami</h5>
                            <p>
                                Platform peyedia lowongan kerja resmi yang
                                menyediakan lebih dari 1000 Pekerjaan.
                            </p>
                        </div>
                        <div
                            class="col-md-3 animate__animated animate__fadeInRight"
                        >
                            <h5>Karyawan</h5>
                            <ul class="list-unstyled">
                                <li>
                                ...
                                <li>
                                    <a
                                        href="{{ route('savedJobs') }}"
                                        class="text-white"
                                        ><i class="fas fa-info me-2"></i>Lihat
                                        Status Lamaran</a
                                    >
                                </li>
                            </ul>
                            ...
                            <ul class="list-unstyled">
                                <li>
                                    <a href="#" class="text-white"
                                        ...
                                        >Buat Lowongan Kerja</a
                                    >
                                </li>
                                <li>
                                    <a href="#" class="text-white"
                                        ><i class="fas fa-search me-2"></i
                                        >Kelola Lamaran Masuk</a
                                    >
                                </li>
                                <li>
                                    <a href="#" class="text-white"
